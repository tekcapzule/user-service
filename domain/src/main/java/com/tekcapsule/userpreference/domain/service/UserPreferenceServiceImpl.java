...
import com.tekcapsule.userpreference.domain.model.DateOfBirth;
...
import com.tekcapsule.userpreference.domain.repository.UserPreferenceDynamoRepository;
...
public class UserPreferenceServiceImpl implements UserPreferenceService {
    private UserPreferenceDynamoRepository mentorRepository;

    @Autowired
    public UserPreferenceServiceImpl(UserPreferenceDynamoRepository mentorRepository) {
